...
const localSlice = toolkit.createSlice({
    name: "local",
...
function Redux(props) {
    return (jsxRuntime.jsx(reactRedux.Provider, Object.assign({ store: store }, { children: jsxRuntime.jsx(ReduxChildren, Object.assign({}, props)) })));
}
function ReduxChildren(props) {
    const local = reactRedux.useSelector((state) => state.local);
    React.useEffect(() => {
