...
export function cookie(
  ...
  if (key === undefined) return all_cookies;
...
export function date_format(
  date: string | null | undefined | Date = undefined,
  format: string = "Y/n/j H:i"
): string {
 ...
 * @return {*}  {object}
 */
export function sortJSON<T = object>(json: T): T {
  return Object.fromEntries(
    Object.entries(json as object).sort(
